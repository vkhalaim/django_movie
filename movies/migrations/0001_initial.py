    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagline', models.CharField(default=0, max_length=100, verbose_name='Tagline')),
                ('description', models.TextField(verbose_name='Description')),
                ...
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Premiere in the world')),
                ...
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='in dollars', verbose_name='Fees in USA')),
